...
namespace IA_Projet
{
    class SearchTree
    {
        ...
        /// <summary>
        /// Fonction qui compte le nombre de noeud dans la liste ouverte (Noeuds à traiter)
        /// Permet de savoir si la liste est vide ou pas
        /// </summary>
        /// <returns> Le nombre (int) de noeuds dans la liste</returns>
        ...
        /// <summary>
        /// Fonction qui compte le nombre de noeud dans la liste fermée (Noeuds déjà traités)
        /// Permet de savoir si la liste est vide ou pas
        /// </summary>
        /// <returns> Le nombre (int) de noeuds dans la liste</returns>
        ...
        /// <summary>
        /// Cherche le noeud passé en param dans la liste Fermée
        /// Permet de savoir si un noeud à déjà été traité ou pas, si c'est le cas, on ne le traite pas ( pas de calculs )
        /// </summary>
        /// <param name="N2"></param>
        /// <returns>Renvoie le noeud s'il est dans la liste fermée, null sinon</returns>
        ...
        /// <summary>
        /// Cherche le noeud passé en param dans la liste Fermée.
        /// Permet de savoir si un noeud à déjà été traité depuis un autre parent, s'il est dans la liste, alors on a déjà
        /// calculé son G, son H et son F. On recalcule depuis le noeud courant pour comparer et garder la meilleure solution.
        /// </summary>
        /// <param name="N2"></param>
        /// <returns>Renvoie le noeud s'il est dans la liste ouverte, null sinon</returns>
        ...
        /// <summary>
        /// Fonction qui renvoie le plus cours chemin entre le node N0 passé en param et le node d'arrivée.
        /// </summary>
        /// <param name="N0"></param>
        /// <returns>Liste contenant les node du chemin</returns>
        ...
        /// <summary>
        /// Calcule le cout de chaque voisin du noeud passé en param.
        /// </summary>
        /// <param name="N"></param>
        ...
        /// <summary>
        /// Insère le nouveau node au bon endroit dans la liste ouverte
        /// </summary>
